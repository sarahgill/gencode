...
public class Main {
    ...
    public static String getView(String allViews){
        ...
        if(viewKeysJson.size() == 0){
            ...
            String guiParam = "'list': [{'value':'forLoops', 'title':'For Loops'},{'value':'conditional', 'title':'Conditional'}, {'value': 'array', 'title':'Array'}, {'value': '2darray', 'title': 'Two Dimensional Arrays'}]";
